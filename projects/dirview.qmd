...
The typing bar is in workable state and that's all that's needed right now. Next up is to display items
in the current directory. Will also figure out how to get `fzf` to show just the items in the current directory.
